...
namespace ZONEDOCTOR
{
    public partial class NewMessageBox : NewForm
    {
        ...
        {
            if (MessageBox.Show("You are about to clear the entire history of all past actions performed within the Zone Doctor application.\n\n" +
                "Are you sure you want to do this?", "ZONE DOCTOR", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) != DialogResult.Yes)
                return;
            Model.History = "";
            richTextBox1.Text = "";
        }
