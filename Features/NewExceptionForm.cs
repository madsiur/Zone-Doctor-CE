...
namespace ZONEDOCTOR
{
    public partial class NewExceptionForm : NewForm
    {
        public NewExceptionForm(Exception exception)
        {
            ...
            label1.Text = "Zone Doctor has encountered an error. Please copy ALL of the contents of the box below and post them as a new reply to one of these threads:\n\n";
            ...
            richTextBox1.Text = assembly.ToString() + ", ROMSize=$" + Model.GetFileSize().ToString("X6") + "\r\n\r\n";
            ...
            {
                if (!line.StartsWith("   at ZONEDOCTOR"))
                    continue;
