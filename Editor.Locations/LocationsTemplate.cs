...
{
    public partial class LocationsTemplate : NewForm
    {
        // variables
        private Locations locations;
        private Overlay overlay;
        private LocationTemplate template; public LocationTemplate Template { get { return this.template; } }
        private LocationTemplate templateC;
        ...
        // functions
        public LocationsTemplate(Locations locations, Overlay overlay)
        {
        ...
        public void Reload(Locations locations, Overlay overlay)
        {
            this.locations = locations;
            this.overlay = overlay;
            SetTemplateImage();
        ...
        private void SetTemplateImage()
        {
            ...
            templateImage = Do.PixelsToImage(template.GetTemplatePixels(locations.LOCATION, locations.Tileset),
        ...
        private void templateTransfer_Click(object sender, EventArgs e)
        {
            ...
            foreach (LocationTemplate lt in templates)
            {
                if (lt.Name == name)
                {
            ...
            locations.Tilemap.Assemble();
            template.Transfer(locations.Tilemap.Tilemaps_Bytes, locations.LocationMap, locations.SoliditySet, overlay.Select.Location, overlay.Select.Terminal);
            // add to listbox
        ...
        private void templateImport_Click(object sender, EventArgs e)
        {
            ...
            foreach (string path in openFileDialog1.FileNames)
            {
                ...
                LocationTemplate temp = (LocationTemplate)b.Deserialize(s);
                templates.Add(temp);
        ...
        private void templatesLoaded_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (templatesLoaded.SelectedIndex == -1)
                return;
            template = (LocationTemplate)templates[templatesLoaded.SelectedIndex];
        ...
        private void templateRenameText_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("A template name cannot be empty.", "ZONE DOCTOR");
                return;
            }
            foreach (LocationTemplate lt in templates)
            {
