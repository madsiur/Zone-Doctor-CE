...
namespace ZONEDOCTOR.ScriptsEditor.Commands
{
    ...
    {
        #region Static Data
        private static string[] MapCommands = new string[]
        {
            "","","","","","","","","","","","","","","","",			// 0x00
            "","","","","","","","","","","","","","","","",			// 0x10
            "","","","","","","","","","","","","","","","",			// 0x20
            ...
            "Change character to ship graphic",			// 0xFC
            "Show Figaro Castle submerging",			// 0xFD
            "Show Figaro Castle emerging",			// 0xFE
            "End map script"			// 0xFF
        };
        #endregion
        public string InterpretMapCommand(ActionCommand asc)
        {
            ...
            switch (asc.Opcode)
            {
                ...
                default:
                    ...
                    else if (asc.Opcode >= 0x40 && asc.Opcode <= 0x7F)
                    {
                        ...
                        command = MapCommands[asc.Opcode];
                    return string.Format(command, vars);
            }
            return string.Format(MapCommands[asc.Opcode], vars);
        }
    }
}